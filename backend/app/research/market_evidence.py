...
class MarketEvidenceVerificationError(
    ResearchEvidenceLedgerError
):
    pass
...
class MarketAnalysisDraft(BaseModel):
    """AI-facing Market synthesis without source metadata authority."""
    ...
    def validate_draft(
        ...
        if (
            ...
            raise ValueError(
                "A Market draft without findings "
...
def _collect_claimed_source_ids(
    ...
    for finding in findings:
        if (
            ...
            raise MarketEvidenceVerificationError(
                "Numerical Market findings must "
...
def finalize_market_analysis(
    *,
    ...
    if (
        ...
        raise MarketEvidenceVerificationError(
            "Market analysis requires a "
            "MARKET_RESEARCH evidence ledger"
        )
    ...
    if (
        ...
        raise MarketEvidenceVerificationError(
            "A non-insufficient Market analysis "
    ...
    try:
        ...
        raise MarketEvidenceVerificationError(
            "Market analysis referenced evidence "
