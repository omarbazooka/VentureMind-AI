    ...
    def build_crew(self) -> Crew:
        ...
        research_task = Task(
            description=(
                ...
                "the product, category, and geography "
                "(e.g. 'gym management software Egypt'). "
                ...
                "4. Immediately after search discovery, you MUST "
                "use controlled_batch_page_retrieval to inspect "
                "up to four candidate URLs from 3-4 DISTINCT "
                "competitors in ONE parallel batch. Calling "
                "controlled_batch_page_retrieval is MANDATORY "
                "before completing the research task.\n"
                ...
                "- geography relevance.\n\n"
                "WEAKNESS & INFERENCE SAFETY RULES:\n"
                "- Never convert 'not mentioned' into "
                "'does not have'. Absence of evidence is "
                "not evidence of absence.\n"
                "- An INFERRED weakness is allowed ONLY when "
                "evidence positively establishes a product "
                "characteristic, scope, trade-off, operating "
                "model, pricing structure, or workflow (e.g. broad "
                "multi-location scope increasing setup complexity).\n"
                "- You MUST NOT infer missing local or regional "
                "feature support (e.g. 'might have weaker Egyptian "
                "payment support') merely because a competitor is "
                "global or local integration is unmentioned. If "
                "unmentioned, record the gap in limitations, NOT "
                "as a competitor weakness.\n"
                "- An INFERRED weakness MUST NOT use absence phrasing "
                "such as 'lacks', 'does not have', 'does not support', "
                "or 'missing feature' unless directly verified.\n"
                "- If no defensible weakness is available, "
                "leave weaknesses empty.\n\n"
                "PRICING & DETAIL RULES:\n"
                "- If actual pricing or a verified commercial term "
                "(e.g. $99/month, 30-day trial) is unavailable, "
                "set pricing to null.\n"
                "- Do not use 'pricing is not published' or "
                "'pricing unavailable' as pricing data or as a "
                "competitor weakness.\n\n"
                "EVIDENCE RULES:\n"
        ...
        synthesis_task = Task(
            description=(
                ...
                "- Summary must describe the active competitive "
                "landscape. Summary MUST NOT claim 'product-market fit', "
                "'product market fit', 'PMF', or 'validated market fit'.\n"
                ...
                "- Preserve multiple defensible competitors if evidence "
                "supports them. Do not collapse synthesis to a single profile.\n"
                ...
                "- Weaknesses must describe potential trade-offs "
                "or risks (e.g. broad product scope causing complexity). "
                "An INFERRED weakness MUST NOT use absence language "
                "such as 'lacks', 'does not have', 'does not support', "
                "or 'missing' unless directly verified by evidence.\n"
                "- Top-level findings generalizing competitor capabilities "
                "(e.g. 'competitors emphasize X') MUST be supported by evidence "
                "from multiple competitors, not just one.\n"
                "- If actual pricing or a verified commercial term "
                "(e.g. $99/month, 30-day trial) is unavailable, set "
                "pricing to null. Do NOT output 'Pricing is not published' "
                "or 'Pricing unavailable' as pricing data or as a weakness.\n"
