    ...
    def build_crew(self) -> Crew:
        ...
        research_task = Task(
            description=(
                ...
                "up to four official candidate URLs in ONE parallel "
                "batch. Calling controlled_batch_page_retrieval is "
                "MANDATORY before completing the research task.\n"
                ...
                "the limitation.\n"
                "- An INFERRED weakness must describe a potential "
                "trade-off or risk (e.g. broad product scope "
                "increasing setup complexity) supported by explicit "
                "evidence. It MUST NOT use absence phrasing such "
                "as 'lacks', 'does not have', 'does not support', "
