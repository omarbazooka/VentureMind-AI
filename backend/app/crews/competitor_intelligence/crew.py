    ...
    def build_crew(
        ...
        research_task = Task(
            description=(
                ...
                "- Use the controlled research tool "
                ...
                "is unavailable, explicitly record "
                "that limitation.\n"
            ...
            expected_output=(
                ...
                "customer need. Include verified "
                "competitor or alternative "
                "observations, exact source IDs, "
                "source titles, URLs, snippets, "
                "relevant product/pricing/"
        ...
        synthesis_task = Task(
            description=(
                ...
                "resolved.\n"
                "- If reliable competitor evidence "
                "is unavailable, use evidence "
                "quality INSUFFICIENT and explain "
                "the limitations.\n"
