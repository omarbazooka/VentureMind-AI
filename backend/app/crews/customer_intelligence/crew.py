    ...
    def build_crew(self) -> Crew:
        ...
        research_task = Task(
            description=(
                ...
                "- DEMAND SIGNAL SAFETY: A single discussion thread or blog is NOT proof of "
                "'high global/regional demand'. Bound demand findings to what evidence actually supports.\n"
