...
import app.services.customer_intelligence_executor as executor
...
def make_customer_result(
) -> CustomerAnalysis:
    return CustomerAnalysis(
        summary=(
            "Reliable customer evidence "
...
def test_executor_completes_customer_stage(
    monkeypatch,
):
    claim = make_claim()

    customer_result = (
        make_customer_result()
    )
...
def test_executor_rejects_non_customer_stage(
    monkeypatch,
):
    claim = make_claim(
        stage=(
